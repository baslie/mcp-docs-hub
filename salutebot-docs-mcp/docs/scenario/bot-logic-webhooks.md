...
Сообщения, которыми чат-бот обменивается со сторонним вебхуком, соответствуют [протоколу вебхуков Graph](bot-logic-webhooks.md#protokol-vebhukov-smart-app-graph).
