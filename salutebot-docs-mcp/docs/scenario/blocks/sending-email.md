...
Graph
Code
Если вы разрабатываете сценарий в Graph, для отправки почты используйте блок [**Отправка email**](sending-email.md). По нажатию на поле **От кого** откроется окно **Новый адрес отправителя**.
