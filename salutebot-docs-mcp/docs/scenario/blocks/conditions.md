...
Для настройки условия следует выбрать каналы из списка. Если в настройках явно не указан тип канала, то пользователь, пришедший из него, будет направлен на переход **Иначе**. Для готового условия, следует указать [функцию](https://developers.sber.ru/docs/ru/va/graph/variables/system_variables), которая определяет канал.
...
![Присвоение нуля](https://developers.sber.ru/docs/assets/images/conditions_1-38888d88698733f52ab1a61898f18550.png)