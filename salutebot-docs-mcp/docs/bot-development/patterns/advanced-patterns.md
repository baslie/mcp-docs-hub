...
## $regexp
`$regexp<литералы и метасимволы>` — [регулярное выражение ](https://ru.wikipedia.org/wiki/%D0%A0%D0%B5%D0%B3%D1%83%D0%BB%D1%8F%D1%80%D0%BD%D1%8B%D0%B5_%D0%B2%D1%8B%D1%80%D0%B0%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F) — строка, которая является шаблоном, описывающим некий набор строк. В `$regexp` будут попадать строки, соответствующие шаблону.
