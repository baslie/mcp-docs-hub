...
Чтобы использовать готовые сценарии:
  ...
  3. В окне Добавить готовый сценарий выберите систему, с которой нужно настроить интеграцию, и нажмите кнопку Далее. Если подходящей системы нет в списке, вы можете предложить добавить ее.
