...
Сценарии проектов Graph размечены с помощью [мета-тегов](project-export-import.md#meta-tegi2). Для корректной работы проектов в Code, теги требуется удалить.
## Экспорт проекта
