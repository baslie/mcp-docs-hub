...
Для настройки интеграции:
  1. Предварительно [запросите ](https://developers.sber.ru/studio/service-request/edna-integration) доступ к EDNA в StudioAdmin. При получении заявки в работу вы получите письмо на указанный ранее адрес. После согласования заявки модератором новая интеграция появится в списке интеграций проекта SaluteBot.
